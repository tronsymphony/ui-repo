...
<div class="col-lg-4 col-sm-6 pb-4 p-md-4">
  <div class="card h-100">
    ...
    <div class="card-body text-center d-flex flex-column justify-content-around align-items-center">
      <h2 class="card-title reveal-2"><?php echo wp_trim_words( get_the_title(), 4 ); // post title ?></h2>
      <p class="card-text reveal-2"><?php echo wp_trim_words( get_the_excerpt(), 30 ); // post excerpt?></p>
